...
Revision ID: add_notification_follow_enhancements
...
revision: str = 'add_notification_follow_enhancements'
...
def upgrade() -> None:
    ...
    # Drop and recreate user_follows table with ON DELETE CASCADE
    ...
    # Add composite index on user_follows for efficient queries
    op.create_index(
    ...
    # Add composite index on (user_id, created_at DESC) for efficient notification retrieval
    op.create_index(
    ...
    # Update bookmarks table with ON DELETE CASCADE
    ...
    # Add index on (user_id, post_id) for efficient bookmark queries
    op.create_index(
